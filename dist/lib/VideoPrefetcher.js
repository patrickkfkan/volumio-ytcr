...
var _VideoPrefetcher_instances, _VideoPrefetcher_videoLoader, _VideoPrefetcher_startPrefetchTimer, _VideoPrefetcher_prefetchVideoAbortController, _VideoPrefetcher_logger, _VideoPrefetcher_prefetch;
...
_VideoPrefetcher_videoLoader = new WeakMap(), _VideoPrefetcher_startPrefetchTimer = new WeakMap(), _VideoPrefetcher_prefetchVideoAbortController = new WeakMap(), _VideoPrefetcher_logger = new WeakMap(), _VideoPrefetcher_instances = new WeakSet(), _VideoPrefetcher_prefetch = async function _VideoPrefetcher_prefetch(video) {
    this.abortPrefetch();
